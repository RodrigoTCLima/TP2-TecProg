...
describe 'Calculo aliquota efetiva' do
  let!(:irpf) { IRPF.new }

  [{ descricaoRend: 'Salário', rendimento: 10_000, descricaoDedu: 'Funpresp', deducao: 1000, resultado: 16.05 },
   { descricaoRend: 'Salário', rendimento: 7000,  descricaoDedu: 'Funpresp', deducao: 1000, resultado: 11.15 },
   { descricaoRend: 'Salário', rendimento: 3000,  descricaoDedu: 'Funpresp', deducao: 500,
     resultado: 1.49 }].each do |parametros|
